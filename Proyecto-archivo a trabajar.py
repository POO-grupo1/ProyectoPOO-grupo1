 ...
 # Validaciones del sistema
  ...
  def valida_Cantidad(self, event):
     ...
     try:
        ...
        mssg.showerror('Atención!!','.. ¡Cantidad inválida! ..')
        self.cantidad.delete(0, 'end')  # Limpiar el contenido del Entry en caso de error 
  ...
  def validaFecha(self, event):  
      ...
      if event.char:
         if es_fecha_valida(self.fecha.get()) == False and len(self.fecha.get()) != 0:
